...
class _SliderButtonState extends State<SliderButton> {
  ...
  Widget build(BuildContext context) {
    return Container(
      // Se o estado for loading e hideOnDismiss for false, exibir um CircularProgressIndicator
      child: _isLoading
          ? Center(child: CircularProgressIndicator())
          : _control(), // O método _control() permanece o mesmo
    );
  }
      ...
      children: <Widget>[
        ...
        widget.disable
          ...
          confirmDismiss: (_) async {
            ...
            // Verifica se a ação foi confirmada com sucesso e se hideOnConfirm é true
            if (result && widget.hideOnConfirm) {
              setState(() {
                flag = !flag; // Isso fará o widget desaparecer se hideOnConfirm for true
              });
            }
            ...
            return result; // Retorna o resultado da ação, mas o estado 'flag' só é alterado se hideOnConfirm for true
          },
          child: Container(
            width:
            ...
            child: widget.child ??
                Container(
                  height: widget.buttonSize ?? widget.height,
                  width: widget.buttonWidth ?? widget.height,
                  decoration: BoxDecoration(
                      boxShadow: widget.boxShadow != null
                          ? [
                        widget.boxShadow!,
